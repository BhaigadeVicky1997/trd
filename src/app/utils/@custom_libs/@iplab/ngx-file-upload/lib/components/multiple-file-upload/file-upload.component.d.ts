...
export declare class FileUploadComponent extends FileUploadAbstract implements ControlValueAccessor {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<FileUploadComponent, "file-upload:not([simple])", never, { "control": "control"; "animation": "animation"; "multiple": "multiple"; }, {}, ["templateRef", "listItem"], never>;
}
